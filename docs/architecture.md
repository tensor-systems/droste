...
- `RUNNER_PROTOCOL_VERSION` (currently 10) governs the request/response
  ...
  Protocol v4 through v9 require one exact six-field `budget` object; missing,
  ...
  Protocol v7 embeds Trace ABI v3, where root/subcall usage scopes declare
